...
// AbandonBackupOperation manages a long-running operation from AbandonBackup.
type AbandonBackupOperation struct {
...
func (op *AbandonBackupOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
...
func (op *AbandonBackupOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
...
func (op *AbandonBackupOperation) Metadata() (*backupdrpb.OperationMetadata, error) {
...
func (op *AbandonBackupOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *AbandonBackupOperation) Name() string {
	return op.lro.Name()
}
...
// FinalizeBackupOperation manages a long-running operation from FinalizeBackup.
type FinalizeBackupOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *FinalizeBackupOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*backupdrpb.Backup, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp backupdrpb.Backup
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *FinalizeBackupOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*backupdrpb.Backup, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp backupdrpb.Backup
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *FinalizeBackupOperation) Metadata() (*backupdrpb.OperationMetadata, error) {
	var meta backupdrpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *FinalizeBackupOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *FinalizeBackupOperation) Name() string {
	return op.lro.Name()
}

// RemoveDataSourceOperation manages a long-running operation from RemoveDataSource.
type RemoveDataSourceOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *RemoveDataSourceOperation) Wait(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.WaitWithInterval(ctx, nil, time.Minute, opts...)
}
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *RemoveDataSourceOperation) Poll(ctx context.Context, opts ...gax.CallOption) error {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	return op.lro.Poll(ctx, nil, opts...)
}
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *RemoveDataSourceOperation) Metadata() (*backupdrpb.OperationMetadata, error) {
	var meta backupdrpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *RemoveDataSourceOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *RemoveDataSourceOperation) Name() string {
	return op.lro.Name()
}
...
// SetInternalStatusOperation manages a long-running operation from SetInternalStatus.
type SetInternalStatusOperation struct {
	lro      *longrunning.Operation
	pollPath string
}
...
//
// See documentation of Poll for error-handling information.
func (op *SetInternalStatusOperation) Wait(ctx context.Context, opts ...gax.CallOption) (*backupdrpb.SetInternalStatusResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp backupdrpb.SetInternalStatusResponse
	if err := op.lro.WaitWithInterval(ctx, &resp, time.Minute, opts...); err != nil {
		return nil, err
	}
	return &resp, nil
...
// op.Done will return true, and the response of the operation is returned.
// If Poll succeeds and the operation has not completed, the returned response and error are both nil.
func (op *SetInternalStatusOperation) Poll(ctx context.Context, opts ...gax.CallOption) (*backupdrpb.SetInternalStatusResponse, error) {
	opts = append([]gax.CallOption{gax.WithPath(op.pollPath)}, opts...)
	var resp backupdrpb.SetInternalStatusResponse
	if err := op.lro.Poll(ctx, &resp, opts...); err != nil {
		return nil, err
...
// To get the latest metadata, call this method after a successful call to Poll.
// If the metadata is not available, the returned metadata and error are both nil.
func (op *SetInternalStatusOperation) Metadata() (*backupdrpb.OperationMetadata, error) {
	var meta backupdrpb.OperationMetadata
	if err := op.lro.Metadata(&meta); err == longrunning.ErrNoMetadata {
		return nil, nil
	} else if err != nil {
...
// Done reports whether the long-running operation has completed.
func (op *SetInternalStatusOperation) Done() bool {
	return op.lro.Done()
}

// Name returns the name of the long-running operation.
// The name is assigned by the server and is unique within the service from which the operation is created.
func (op *SetInternalStatusOperation) Name() string {
	return op.lro.Name()
}
