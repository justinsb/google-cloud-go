...
type CallOptions struct {
	...
	RemoveDataSource            []gax.CallOption
	SetInternalStatus           []gax.CallOption
	InitiateBackup              []gax.CallOption
	AbandonBackup               []gax.CallOption
	FinalizeBackup              []gax.CallOption
...
type internalClient interface {
	...
	RemoveDataSource(context.Context, *backupdrpb.RemoveDataSourceRequest, ...gax.CallOption) (*RemoveDataSourceOperation, error)
	RemoveDataSourceOperation(name string) *RemoveDataSourceOperation
	SetInternalStatus(context.Context, *backupdrpb.SetInternalStatusRequest, ...gax.CallOption) (*SetInternalStatusOperation, error)
	SetInternalStatusOperation(name string) *SetInternalStatusOperation
	InitiateBackup(context.Context, *backupdrpb.InitiateBackupRequest, ...gax.CallOption) (*backupdrpb.InitiateBackupResponse, error)
	AbandonBackup(context.Context, *backupdrpb.AbandonBackupRequest, ...gax.CallOption) (*AbandonBackupOperation, error)
	AbandonBackupOperation(name string) *AbandonBackupOperation
	FinalizeBackup(context.Context, *backupdrpb.FinalizeBackupRequest, ...gax.CallOption) (*FinalizeBackupOperation, error)
	FinalizeBackupOperation(name string) *FinalizeBackupOperation
	FetchAccessToken(context.Context, *backupdrpb.FetchAccessTokenRequest, ...gax.CallOption) (*backupdrpb.FetchAccessTokenResponse, error)
...
// TestIamPermissions returns the caller’s permissions on a BackupVault resource.
//
...
// RemoveDataSource deletes a DataSource. This is a custom method instead of a standard delete
// method because external clients will not delete DataSources except for
// BackupDR backup appliances.
func (c *Client) RemoveDataSource(ctx context.Context, req *backupdrpb.RemoveDataSourceRequest, opts ...gax.CallOption) (*RemoveDataSourceOperation, error) {
	return c.internalClient.RemoveDataSource(ctx, req, opts...)
}

// RemoveDataSourceOperation returns a new RemoveDataSourceOperation from a given name.
// The name must be that of a previously created RemoveDataSourceOperation, possibly from a different process.
func (c *Client) RemoveDataSourceOperation(name string) *RemoveDataSourceOperation {
	return c.internalClient.RemoveDataSourceOperation(name)
}

// SetInternalStatus sets the internal status of a DataSource.
func (c *Client) SetInternalStatus(ctx context.Context, req *backupdrpb.SetInternalStatusRequest, opts ...gax.CallOption) (*SetInternalStatusOperation, error) {
	return c.internalClient.SetInternalStatus(ctx, req, opts...)
}

// SetInternalStatusOperation returns a new SetInternalStatusOperation from a given name.
// The name must be that of a previously created SetInternalStatusOperation, possibly from a different process.
func (c *Client) SetInternalStatusOperation(name string) *SetInternalStatusOperation {
	return c.internalClient.SetInternalStatusOperation(name)
}

// InitiateBackup internal only.
// Initiates a backup.
func (c *Client) InitiateBackup(ctx context.Context, req *backupdrpb.InitiateBackupRequest, opts ...gax.CallOption) (*backupdrpb.InitiateBackupResponse, error) {
	return c.internalClient.InitiateBackup(ctx, req, opts...)
}

// AbandonBackup internal only.
// Abandons a backup.
func (c *Client) AbandonBackup(ctx context.Context, req *backupdrpb.AbandonBackupRequest, opts ...gax.CallOption) (*AbandonBackupOperation, error) {
	return c.internalClient.AbandonBackup(ctx, req, opts...)
}

// AbandonBackupOperation returns a new AbandonBackupOperation from a given name.
// The name must be that of a previously created AbandonBackupOperation, possibly from a different process.
func (c *Client) AbandonBackupOperation(name string) *AbandonBackupOperation {
	return c.internalClient.AbandonBackupOperation(name)
}

// FinalizeBackup internal only.
// Finalize a backup that was started by a call to InitiateBackup.
func (c *Client) FinalizeBackup(ctx context.Context, req *backupdrpb.FinalizeBackupRequest, opts ...gax.CallOption) (*FinalizeBackupOperation, error) {
	return c.internalClient.FinalizeBackup(ctx, req, opts...)
}

// FinalizeBackupOperation returns a new FinalizeBackupOperation from a given name.
// The name must be that of a previously created FinalizeBackupOperation, possibly from a different process.
func (c *Client) FinalizeBackupOperation(name string) *FinalizeBackupOperation {
	return c.internalClient.FinalizeBackupOperation(name)
}

// FetchAccessToken internal only.
// Fetch access token for a given data source.
func (c *Client) FetchAccessToken(ctx context.Context, req *backupdrpb.FetchAccessTokenRequest, opts ...gax.CallOption) (*backupdrpb.FetchAccessTokenResponse, error) {
...
func (c *gRPCClient) RemoveDataSource(ctx context.Context, req *backupdrpb.RemoveDataSourceRequest, opts ...gax.CallOption) (*RemoveDataSourceOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).RemoveDataSource[0:len((*c.CallOptions).RemoveDataSource):len((*c.CallOptions).RemoveDataSource)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.RemoveDataSource(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &RemoveDataSourceOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *gRPCClient) SetInternalStatus(ctx context.Context, req *backupdrpb.SetInternalStatusRequest, opts ...gax.CallOption) (*SetInternalStatusOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_source", url.QueryEscape(req.GetDataSource()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).SetInternalStatus[0:len((*c.CallOptions).SetInternalStatus):len((*c.CallOptions).SetInternalStatus)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.SetInternalStatus(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &SetInternalStatusOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *gRPCClient) InitiateBackup(ctx context.Context, req *backupdrpb.InitiateBackupRequest, opts ...gax.CallOption) (*backupdrpb.InitiateBackupResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_source", url.QueryEscape(req.GetDataSource()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).InitiateBackup[0:len((*c.CallOptions).InitiateBackup):len((*c.CallOptions).InitiateBackup)], opts...)
	var resp *backupdrpb.InitiateBackupResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.InitiateBackup(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
func (c *gRPCClient) AbandonBackup(ctx context.Context, req *backupdrpb.AbandonBackupRequest, opts ...gax.CallOption) (*AbandonBackupOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_source", url.QueryEscape(req.GetDataSource()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).AbandonBackup[0:len((*c.CallOptions).AbandonBackup):len((*c.CallOptions).AbandonBackup)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.AbandonBackup(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &AbandonBackupOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *gRPCClient) FinalizeBackup(ctx context.Context, req *backupdrpb.FinalizeBackupRequest, opts ...gax.CallOption) (*FinalizeBackupOperation, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "data_source", url.QueryEscape(req.GetDataSource()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).FinalizeBackup[0:len((*c.CallOptions).FinalizeBackup):len((*c.CallOptions).FinalizeBackup)], opts...)
	var resp *longrunningpb.Operation
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.FinalizeBackup(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
	}
	return &FinalizeBackupOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, resp),
	}, nil
}

func (c *gRPCClient) FetchAccessToken(ctx context.Context, req *backupdrpb.FetchAccessTokenRequest, opts ...gax.CallOption) (*backupdrpb.FetchAccessTokenResponse, error) {
	hds := []string{"x-goog-request-params", fmt.Sprintf("%s=%v", "name", url.QueryEscape(req.GetName()))}

	hds = append(c.xGoogHeaders, hds...)
	ctx = gax.InsertMetadataIntoOutgoingContext(ctx, hds...)
	opts = append((*c.CallOptions).FetchAccessToken[0:len((*c.CallOptions).FetchAccessToken):len((*c.CallOptions).FetchAccessToken)], opts...)
	var resp *backupdrpb.FetchAccessTokenResponse
	err := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		var err error
		resp, err = c.client.FetchAccessToken(ctx, req, settings.GRPC...)
		return err
	}, opts...)
	if err != nil {
		return nil, err
...
// method because external clients will not delete DataSources except for
// BackupDR backup appliances.
func (c *restClient) RemoveDataSource(ctx context.Context, req *backupdrpb.RemoveDataSourceRequest, opts ...gax.CallOption) (*RemoveDataSourceOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
...
// SetInternalStatus sets the internal status of a DataSource.
func (c *restClient) SetInternalStatus(ctx context.Context, req *backupdrpb.SetInternalStatusRequest, opts ...gax.CallOption) (*SetInternalStatusOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:setInternalStatus", req.GetDataSource())
...
// InitiateBackup internal only.
// Initiates a backup.
func (c *restClient) InitiateBackup(ctx context.Context, req *backupdrpb.InitiateBackupRequest, opts ...gax.CallOption) (*backupdrpb.InitiateBackupResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:initiateBackup", req.GetDataSource())
	...
	opts = append((*c.CallOptions).InitiateBackup[0:len((*c.CallOptions).InitiateBackup):len((*c.CallOptions).InitiateBackup)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &backupdrpb.InitiateBackupResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// AbandonBackup internal only.
// Abandons a backup.
func (c *restClient) AbandonBackup(ctx context.Context, req *backupdrpb.AbandonBackupRequest, opts ...gax.CallOption) (*AbandonBackupOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:abandonBackup", req.GetDataSource())
...
// FinalizeBackup internal only.
// Finalize a backup that was started by a call to InitiateBackup.
func (c *restClient) FinalizeBackup(ctx context.Context, req *backupdrpb.FinalizeBackupRequest, opts ...gax.CallOption) (*FinalizeBackupOperation, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:finalizeBackup", req.GetDataSource())
...
// FetchAccessToken internal only.
// Fetch access token for a given data source.
func (c *restClient) FetchAccessToken(ctx context.Context, req *backupdrpb.FetchAccessTokenRequest, opts ...gax.CallOption) (*backupdrpb.FetchAccessTokenResponse, error) {
	m := protojson.MarshalOptions{AllowPartial: true, UseEnumNumbers: true}
	jsonReq, err := m.Marshal(req)
	if err != nil {
		return nil, err
	...
	baseUrl.Path += fmt.Sprintf("/v1/%v:fetchAccessToken", req.GetName())
	...
	opts = append((*c.CallOptions).FetchAccessToken[0:len((*c.CallOptions).FetchAccessToken):len((*c.CallOptions).FetchAccessToken)], opts...)
	unm := protojson.UnmarshalOptions{AllowPartial: true, DiscardUnknown: true}
	resp := &backupdrpb.FetchAccessTokenResponse{}
	e := gax.Invoke(ctx, func(ctx context.Context, settings gax.CallSettings) error {
		if settings.Path != "" {
			baseUrl.Path = settings.Path
		}
...
// AbandonBackupOperation returns a new AbandonBackupOperation from a given name.
// The name must be that of a previously created AbandonBackupOperation, possibly from a different process.
func (c *gRPCClient) AbandonBackupOperation(name string) *AbandonBackupOperation {
	return &AbandonBackupOperation{
...
// AbandonBackupOperation returns a new AbandonBackupOperation from a given name.
// The name must be that of a previously created AbandonBackupOperation, possibly from a different process.
func (c *restClient) AbandonBackupOperation(name string) *AbandonBackupOperation {
...
// FinalizeBackupOperation returns a new FinalizeBackupOperation from a given name.
// The name must be that of a previously created FinalizeBackupOperation, possibly from a different process.
func (c *gRPCClient) FinalizeBackupOperation(name string) *FinalizeBackupOperation {
	return &FinalizeBackupOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// FinalizeBackupOperation returns a new FinalizeBackupOperation from a given name.
// The name must be that of a previously created FinalizeBackupOperation, possibly from a different process.
func (c *restClient) FinalizeBackupOperation(name string) *FinalizeBackupOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &FinalizeBackupOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// RemoveDataSourceOperation returns a new RemoveDataSourceOperation from a given name.
// The name must be that of a previously created RemoveDataSourceOperation, possibly from a different process.
func (c *gRPCClient) RemoveDataSourceOperation(name string) *RemoveDataSourceOperation {
	return &RemoveDataSourceOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// RemoveDataSourceOperation returns a new RemoveDataSourceOperation from a given name.
// The name must be that of a previously created RemoveDataSourceOperation, possibly from a different process.
func (c *restClient) RemoveDataSourceOperation(name string) *RemoveDataSourceOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &RemoveDataSourceOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
...
// SetInternalStatusOperation returns a new SetInternalStatusOperation from a given name.
// The name must be that of a previously created SetInternalStatusOperation, possibly from a different process.
func (c *gRPCClient) SetInternalStatusOperation(name string) *SetInternalStatusOperation {
	return &SetInternalStatusOperation{
		lro: longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
	}
}
...
// SetInternalStatusOperation returns a new SetInternalStatusOperation from a given name.
// The name must be that of a previously created SetInternalStatusOperation, possibly from a different process.
func (c *restClient) SetInternalStatusOperation(name string) *SetInternalStatusOperation {
	override := fmt.Sprintf("/v1/%s", name)
	return &SetInternalStatusOperation{
		lro:      longrunning.InternalNewOperation(*c.LROClient, &longrunningpb.Operation{Name: name}),
		pollPath: override,
